...
namespace CharacterExpressions
{
    public class CharacterExpression_Jaw_Behaviour : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            CharacterExpression_Services.UpdateJaw_WithConfig(Config, JawIKRig_Target, Talking, CurrentOrientation, out CurrentOrientation, Time.timeSinceLevelLoad, Control);
        }
    }
}
